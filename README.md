...
## Live Demo
[View the Live Project](https://tehila6791-cpu.github.io/Recipes/)
...
1. **Authentication Module:** Handles user identification and access control via a login screen.
2. **Configuration Dashboard:** Manages user-specific environmental variables such as narration speed and UI themes.
3. **Discovery Layer:** A searchable interface for browsing and filtering the recipe collection.
4. **Execution View:** The active cooking interface containing ingredients, methods, and playback controls.
